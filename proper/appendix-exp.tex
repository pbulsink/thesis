...
Multiple views of each x-ray structure (including full unit cell) as discussed in \autoref{chap.newchem}.
\todo{Add X-ray structures}
...
\section{(terpy-$\kappa^2$-N,N$^\prime$)\ce{Re(CO)3Cl} (1)}\label{sec.c1}
...
\section{(terpy-$\kappa^3$-N,N$^\prime$,N$^\prime$ $^\prime$)\ce{Re(CO)2Cl} (2)}\label{sec.c2}
...
\section{(terpy-$\kappa^2$-N,N$^\prime$)\ce{Re(CO)3Br} (3)}\label{sec.c3}
...
\section{(terpy-$\kappa^3$-N,N$^\prime$,N$^{\prime \prime}$)\ce{Re(CO)2Br} (4)}\label{sec.c4}
