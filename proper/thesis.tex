...
\doublespacing
\include{chapter1-intro} %"Organometallic, Photochem & catalysis, rhenium"
\include{chapter2-newchem} %"new geometry chemistry"
\include{chapter3-co2} %"CO2 Chemistry" 
\include{chapter4-mechanism} %"Mechanism Study"
\include{chapter5-turbocontrol} %"Turbocontrol"
\include{chapter6-conclusion} %"Conclusion"
%----------------------------------------------------------------------
% END MATERIAL
%----------------------------------------------------------------------
%###################################
...
\include{appendix-mos}
\include{appendix-readme}
\singlespacing
\include{appendix-glos}
...
\todo{check bibliography for journal styles, formatting issues}
\printbibliography
